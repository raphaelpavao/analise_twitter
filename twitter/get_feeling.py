...
###########################################
def classificafrase(fraseteste):
    #Base de treino
    base = [
    ...
    #Coloca as frequências das palavras
    ...
    #recebimento e classificação das frases
    teste = fraseteste
    stemmer = nltk.stem.RSLPStemmer()
    alegria  = 0
    desgosto = 0
    ...
    for frase in teste:
        ...
        classificacao = (classificador.classify(novo))
        if classificacao == 'alegria':
            alegria = alegria + 1 
        if classificacao == 'desgosto':
            desgosto = desgosto + 1
        if classificacao == 'medo':
            medo = medo + 1
        if classificacao == 'raiva':
            raiva = raiva + 1
        if classificacao == 'surpresa':
            surpresa = surpresa + 1
        if classificacao == 'tristeza':
                tristeza = tristeza + 1    
        sentimento = {}
        sentimento['alegria'] = alegria
        sentimento['desgosto'] = desgosto
        sentimento['medo'] = medo
        sentimento['raiva'] = raiva
        sentimento['surpresa'] = surpresa
        sentimento['tristeza'] = tristeza        
    return sentimento
